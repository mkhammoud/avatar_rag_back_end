...
app_context = AppContext(InnerSQLite('./flights.db'))
        ...
        if "messages" in request.form:
            ...
            if messages_str:
                ...
                if avatarProvider == "local":
                    ...
                    threading.Thread(target=process_chunks_with_limit, args=(
                        chunks, global_config['max_text_to_speech_avatar_thread'], avatarId, voiceId,)).start()
